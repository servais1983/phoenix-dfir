...
export default function SettingsPage() {
  ...
  const handleSave = () => {
    ...
    // Nettoyage des anciens fournisseurs IA (Gemini / Ollama supprimes)
    localStorage.removeItem('phoenix_google_key')
    localStorage.removeItem('phoenix_ollama_model')
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Fournisseur IA unique de Phoenix (API GitHub Models). Cote serveur, definissez la
